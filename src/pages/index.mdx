...
import ms_pipeline from "../assets/ms-pipeline.webp";
...
<Header
  ...
  links={[
    {
      name: "Paper",
      url: "https://openreview.net/group?id=thecvf.com/CVPR/2025/Conference/Authors&referrer=%5BHomepage%5D(%2F)",
      icon: "ri:file-pdf-2-line",
    },
    {
      name: "Code",
      url: "https://github.com/zhangyuhong01/HumanMM",
      icon: "ri:github-line",
    },
    {
      name: "arXiv",
...
<Figure
    ...
    footage and benchmark datasets. We gratefully acknowledge WHAM [1] for sharing their visualization framework that facilitated our result presentations."
  >
  <YouTubeVideo videoId="8RB3PK8orVI" />
</Figure>
</HighlightedSection>
<Figure
...
our method also performs as the best on \msm across all numbers of shots.
<Figure>
